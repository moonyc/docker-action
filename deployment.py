...
def run():
    # special env variables automatically generated by github actions
    bucket = os.environ['INPUT_BUCKET']
    bucket_region = os.environ['INPUT_BUCKET-REGION']
    dist_folder = os.environ['INPUT_DIST-FOLDER']
    html_file = os.environ['INPUT_HTML-FILE']
    ...
    website_url = f'http://{bucket}.s3.{bucket_region}.amazonaws.com/{html_file}'
